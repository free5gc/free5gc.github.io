...
The go-gtp5gnl project bridges user-space control logic and kernel-space GTP-U data forwarding by providing a Go-native Netlink interface to the Linux gtp5g kernel module. It allows free5GC’s UPF—or any custom UPF built on top of gtp5g—to program kernel-level PDR, FAR, and QER rules that implement GTP-U encapsulation, forwarding, and QoS behavior.
...
| **Src** | Source Address<br><ul><li>IP<li>Mask<ul>|
| **Dst** | Destination Address<br><ul><li>IP<li>Mask<ul> |
