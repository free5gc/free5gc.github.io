...
Starting from v4.2.1, free5GC includes support for Prometheus, which can be used with both [free5gc-compose](https://github.com/free5gc/free5gc-compose) and [free5gc-helm](https://github.com/free5gc/free5gc-helm).
