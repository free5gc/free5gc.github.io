...
3. Test the UPF forwarding by checking the output, which should be **1**. If the output is different, ensure that the CNI and OS `ipv4_forwarding` configurations are correctly set.
