...
```
Source: [udm/internal/sbi/processor/generate_auth_data.go](https://github.com/free5gc/udm/blob/main/internal/sbi/processor/generate_auth_data.go)
...
```
Source: [ausf/internal/sbi/processor/ue_authentication.go](https://github.com/free5gc/ausf/blob/main/internal/sbi/processor/ue_authentication.go)
...
```
Source: [amf/internal/gmm/message/build.go](https://github.com/free5gc/amf/blob/main/internal/gmm/message/build.go)
...
if err != nil { fatal.Fatalf("GetKDFValue error: %+v", err) }
```
Source: [free5gc/test/ranUe.go](https://github.com/free5gc/free5gc/blob/main/test/ranUe.go)
...
```
Source: [udm/internal/util/milenage.go](https://github.com/free5gc/udm/blob/main/internal/util/milenage.go)
...
```
Source: [util/ueauth/ueauth.go](https://github.com/free5gc/util/blob/main/ueauth/ueauth.go)
