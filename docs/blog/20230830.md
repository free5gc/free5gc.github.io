...
The traditional approach (left) was to use a Service Mesh Library. It required the Service Mesh Library to be written in the application's language framework.
