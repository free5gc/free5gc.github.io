...
![Figure 1](20230829/1-1.png)


development phase:


1. A program is compiled into an object Executable and Linkable Format file. Using compiler suites like clang/LLVM to compile it into eBPF bytecode.
