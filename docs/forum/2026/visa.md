...
Before traveling to Taiwan, please review the visa requirements and ensure you have a valid visa. Official visa information can be obtained from the [Bureau of Consular Affairs, Ministry of Foreign Affairs](https://www.boca.gov.tw/mp-2.html). Below is a summary of the visa application options. Please select the one that best matches your status to proceed.
...
- Visa/eVisa: If you need a visa to enter Taiwan, we recommend applying for an eVisa. Please follow the instructions provided [here](https://www.boca.gov.tw/lp-149-2.html).
